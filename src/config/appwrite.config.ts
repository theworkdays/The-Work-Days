        ...
        const client = new sdk.Client()
            ...
            return {
                data:{
                    ...
                    avatar: new sdk.Avatars(client),
                    locale: new sdk.Locale(client),
                },
                error:undefined
...
export const createAdminClient = async () => {
    try{
        ...
        console.log(process.env.APPWRITE_ENDPOINT, process.env.APPWRITE_PROJECT_ID, process.env.APPWRITE_PROJECT_API_KEY)
